...
- [ ] Deploy stack on Dockhand to pull and deploy the changes.
- [ ] Access the configured URL through the reverse proxy.
- [ ] Test the main features and core functionalities.
- [ ] Verify security configurations and specific env variables.